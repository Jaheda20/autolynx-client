...
const Footer = () => {
    return (
        ...
        <footer className="px-4 divide-y bg-blue-100 dark:text-gray-800">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                
                <div className="flex items-center gap-2 lg:w-1/3">
                <img src={logo} alt="" className="w-20  " />
                <p className="gap-0 text-3xl font-extrabold text-blue-500">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 AutoLynx AB All rights reserved.</div>
        </footer>
    );
};
